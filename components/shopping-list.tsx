                  ...
                  <div className="flex-1 min-w-0">
                    <span
                      className={`block text-xl ${
                        item.checked ? "line-through text-success font-semibold" : "font-bold text-foreground"
                      }`}
                    >
                      {item.name}
                    </span>
                    {!item.checked && (
                      <div className="flex items-center gap-3 mt-2">
                        ...
                        <span className="text-pending font-bold text-xs bg-pending/10 px-2 py-0.5 rounded-md uppercase tracking-wider">
                          À PRENDRE
                        </span>
                      </div>
                    )}
